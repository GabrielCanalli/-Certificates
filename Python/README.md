...
## ⚡ Conquistas e Carga de Conhecimento

Abaixo estão detalhados os três pilares que construí nessa etapa, indo desde os primeiros passos lógicos até a imersão prática em ecossistemas de mercado.
...
* **📂 Arquivo:** [Visualizar Certificado](./caminho-do-arquivo/bradesco.pdf)
...
└── 📁 pdfs/
    ├── 📄 bradesco_python.pdf
    ├── 📄 santander_python.pdf
    └── 📄 mundo1_curso_em_video.pdf
